  ...
  return (
    <span className={`inline-flex items-center gap-2 ${className}`}>
      <svg
        ...
        viewBox="0 0 64 64"
        role="img"
        aria-label="Nkam Cosmetics"
        className="shrink-0"
      >
        <defs>
          <linearGradient id="nkam-mark" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stopColor="#e34d85" />
            <stop offset="100%" stopColor="#a92053" />
          </linearGradient>
        </defs>
        <rect width="64" height="64" rx="16" fill="url(#nkam-mark)" />
        <path
      ...
      {withWordmark && (
        <span className="flex flex-col leading-none">
          <span className="text-lg font-bold text-ink-900">نكام كوسميتيك</span>
          <span className="text-[10px] font-medium tracking-wide text-ink-400">NKAM COSMETICS</span>
        </span>
      )}
    </span>
  )
